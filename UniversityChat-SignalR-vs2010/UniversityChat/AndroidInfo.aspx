<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="AndroidInfo.aspx.cs" Inherits="UniversityChat.WebForm1" %>
...
<br />
Our Android client and source code are available for download on <a href="https://github.com/jschefter/UniversityChat/tree/master/University%20Chat%20Android%20Client">github.</a> 
<br /><br />
Alternatively, you can download the latest packed executable <a href="AndroidLatest/University Chat.apk">here.</a>
<br /><br />
The Android application supports most of the core functionality, including registering an account, logging in, 
joining a chat room, leaving/switching rooms, etc.
<br />

<h1>How to Install</h1>
<br />
To install our application, you must first allow your device to run unsigned applications. This can be done by navigating
