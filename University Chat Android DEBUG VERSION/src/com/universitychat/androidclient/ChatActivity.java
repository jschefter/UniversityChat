...
//        initializeWebView();
    ...
    public void initWebView(View v)
	{
    	initializeWebView();
	}
...
//            	String message2 = message.replace("'", "\\'");
    ...
    private class IncommingWebEvents 
    {
        ...
        {
    		Toast.makeText(getApplicationContext(), "Incoming pageLoadComplete() called", Toast.LENGTH_SHORT).show();
        ...
        {
    		Toast.makeText(getApplicationContext(), "Incoming hubStartDone() called", Toast.LENGTH_SHORT).show();
        ...
        {
        	Toast.makeText(getApplicationContext(), "Set Channel Part 1 List called", Toast.LENGTH_SHORT).show();
        	...
        	chatWindowActivityHandler.post(new Runnable() 
            {
                ...
                public void run() 
                {
                	Toast.makeText(getApplicationContext(), "Set Channel Part 2 (thread) List called", Toast.LENGTH_LONG).show();
